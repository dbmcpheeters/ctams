 ...
 * @author atrimble
 */
public class ITSoloContestEntryController {

    private static final Logger LOG = LoggerFactory.getLogger(ITSoloContestEntryController.class);

    protected static String PROTOCOL = "http";
    protected static String HOST = "localhost";
    protected static int PORT = 8081;
    protected static String PATH = "/solocontestentry";
        ...
        try {
            ...
            if(response != null) {
                try {
                    ...
                    java.util.logging.Logger.getLogger(ITSoloContestEntryController.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
    ...
    protected static void delete() throws Exception {
        ...
        URI uri = new URIBuilder()
                ...
                .setPort(PORT)
                .setPath(PATH)
                .setParameter("id", TestFixture.INSTANCE.soloContestEntry.getId())
                .build();
